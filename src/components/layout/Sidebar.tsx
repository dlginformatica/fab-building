...
const groups: Array<{ label: string; items: Array<{ to: string; label: string; icon: any; exact?: boolean }> }> = [
  { label: "Operativo", items: [
    ...
    { to: "/app/trends", label: "Trend YoY & benchmark", icon: TrendingUp },
  ...
  { label: "Amministrazione", items: [
    ...
    { to: "/app/sla-settings", label: "Preferenze SLA", icon: Bell },
    { to: "/app/scheduled-exports", label: "Export schedulati", icon: CalendarClock },
    ...
    { to: "/app/module-dependencies", label: "Dipendenze moduli", icon: ShieldCheck },
